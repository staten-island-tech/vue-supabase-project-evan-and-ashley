  ...
  <div v-if="sessionStore().session.isLoggedIn">
    <div class="header-content">
      ...
      <div class="search">
        ...
        <input type="text" v-model="inputTitle" id="title" placeholder="What book are you looking for?" class="searchTerm"/>
    <button @click="fetchData" class="searchButton"> search
</button>
      </div>
...
.header-content{ 
  ...
  min-height: 75vh;
  background:
  linear-gradient(rgb(141,39,174,0.3),rgba(141,39,174,0.5)), url(@/images/library-img.jpg);
 }
